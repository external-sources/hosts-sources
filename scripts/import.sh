...
${WGET} -qO- https://mirror1.malwaredomains.com/files/justdomains | sort | uniq -u > date/malwaredomains/domain.list

${WGET} -qO- https://blocklist.site/app/dl/ads | sort | uniq -u > data/blocklist_ads/domain.list
${WGET} -qO- https://blocklist.site/app/dl/fraud | sort | uniq -u > data/blocklist_fraud/domain.list
${WGET} -qO- https://blocklist.site/app/dl/malware | sort | uniq -u > data/blocklist_malware/domain.list
${WGET} -qO- https://blocklist.site/app/dl/phishing | sort | uniq -u > data/blocklist_phising/domain.list
${WGET} -qO- https://blocklist.site/app/dl/ransomware | sort | uniq -u > data/blocklist_ransomeware/domain.list
${WGET} -qO- https://blocklist.site/app/dl/redirect | sort | uniq -u > data/blocklist_redirect/domain.list
${WGET} -qO- https://blocklist.site/app/dl/scam | sort | uniq -u > data/blocklist_scam/domain.list
${WGET} -qO- https://blocklist.site/app/dl/spam | sort | uniq -u > data/blocklist_spam/domain.list
${WGET} -qO- https://blocklist.site/app/dl/tracking | sort | uniq -u > data/blocklist_tracking/domain.list
