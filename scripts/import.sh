...
${wget} -q -O "data/windowsspyblocker/LICENSE" "https://raw.githubusercontent.com/crazy-max/WindowsSpyBlocker/master/LICENSE"
${wget} -q -O "data/windowsspyblocker/README.md" "https://raw.githubusercontent.com/crazy-max/WindowsSpyBlocker/master/README.md"
